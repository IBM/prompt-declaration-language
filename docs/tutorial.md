...
In this program ([file](https://github.com/IBM/prompt-declaration-language//blob/main/examples/tutorial/calling_llm.pdl)), the `document` starts with the word `Hello,`, and we call a model (`ibm/granite-20b-code-instruct-v2`) with this as input prompt. 
...
PDL can accept textual input from a file or stdin. In the following example ([file](https://github.com/IBM/prompt-declaration-language//blob/main/examples/tutorial/input_file.pdl)), the contents of this [file](https://github.com/IBM/prompt-declaration-language//blob/main/examples/input/data.txt) are read by PDL and incorporated in the document. The result is also assigned to a variable `HELLO`.
...
following [example](https://github.com/IBM/prompt-declaration-language//blob/main/examples/consultant/biz_rules_extraction.pdl):
...
which includes the following [file](https://github.com/IBM/prompt-declaration-language//blob/main/examples/consultant/function.pdl):
...
When we execute this program, we obtain 3 math problems like the ones in the [examples](https://github.com/IBM/prompt-declaration-language//blob/main/examples/arith/). Try it! 

## For Loops

PDL also offers `for` loops over lists.
The following [example](https://github.com/IBM/prompt-declaration-language//blob/main/examples/tutorial/hello.pdl) simply prints each value in the list followed by a newline:
