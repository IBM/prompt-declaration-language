...
\newcommand{\pdlfunction}[2]{\ensuremath{\jsobj{\mtt{params:}{#1}\mtt{,}  {#2}}}}
\newcommand{\pdlclosure}[3]{\ensuremath{\jsobj{\mtt{params:}{#1}\mtt{,}  {#2}, \mtt{scope:}{#3}}}}
...
%  \pdlsemp{S_x[x \leftarrow v_x]}{\pdlblockdefs{\jsobj{\mit{defs}}}{\mit{block}}}{S'}{v}{s}
% }
% {\pdlsemp{S}{\pdlblockdefs{\jsobj{\pdldef{x}{b_x}\mtt{,} \mit{defs}}}{\mit{block}}}{S'}{v}{s}}

\inferrule%
{\pdlsembb{S}{b_x}{S_x}{v_x}{s_x} \\
 \pdlsemp{S}{\pdlblockdefs{\jsobj{\mit{defs}}}{\mit{block}}}{S'}{v}{s}
}
{\pdlsemp{S}{\pdlblockdefs{\jsobj{\pdldef{x}{b_x}\mtt{,} \mit{defs}}}{\mit{block}}}{S'[x \leftarrow v_x]}{v}{s}}
...
{\pdlsemp{S}{p_1}{S_1}{v_1}{s_1} \\
 \pdlsemp{S_1[\mit{context} \leftarrow S(\mit{context}) + s_1]}{\mit{prompts}}{S'}{\mit{vs}}{s}
}
{\pdlsemp{S}{\jsarr{p_1, \mit{prompts}}}
          {S'}{\jsarr{v_1\mtt{,} \mit{vs}}}{s_1 + s}}
